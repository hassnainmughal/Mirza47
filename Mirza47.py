...
\x1b[0;33m║WELCOME TO MY TOOLS  [🔥 Mughal Zada 🔥].  ║

\x1b[0;33m║       #TOOL AUTHOR [ Hassnain Mūghal ]. ║
...
\x1b[0;33m║#FACEBOOK : NAME [Hassnain Mūghal ].       ║

\x1b[0;33m║#GITHUB : https://github.com/Mirza47.   ║

\x1b[0;33m║#WHATSAPP : 03213230513.                   ║
...
def menu():
	...
	elif Mirza == "1" or king == "01":

		publik()

		method()

	elif Mirza == "2" or king == "02":

		follower()

		method()

	elif Mirza == "3" or  king == "03":

		massal()

		method()

	elif MIRZA == "4" or KING == "04":
	...
	elif Mirza == "5" or Mirza == "05":

		setting_ua()

	elif Mirza == "0" or Mirza == "00":
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mMIRZA PRO/FASTER \033[1;97m]")
